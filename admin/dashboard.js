...
function initializeDashboard() {
  ...
  onSnapshot(query(collection(db, "announcements"), orderBy("startDate", "desc")),
    snap => renderList(annList, snap.docs, "announcements")
  );

  onSnapshot(query(collection(db, "events"), orderBy("startDate", "asc")),
    snap => renderList(eventList, snap.docs, "events")
  );

  onSnapshot(query(collection(db, "academicCalendar"), orderBy("startDate", "asc")),
    snap => renderList(calendarList, snap.docs, "academicCalendar")
  );
}
